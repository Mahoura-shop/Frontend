    ...
    <div className="min-h-[calc(100vh-4rem)] py-8">
      <div className="container mx-auto px-4">
        ...
        <Button
          ...
          className="mb-6"
        >
          <ArrowLeft className={language === 'fa' ? 'ml-2 h-4 w-4' : 'mr-2 h-4 w-4'} />
          {t('backToProducts')}
        </Button>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-primary" style={{ fontSize: '1.75rem', fontWeight: 500 }}>
            ...
            <div className="mb-6 grid grid-cols-2 gap-4">
              <div>
                <p className="mb-1 text-muted-foreground">{t('category')}</p>
                <p>{product.category}</p>
              </div>
              <div>
                <p className="mb-1 text-muted-foreground">{t('brand')}</p>
                <p>{product.brand}</p>
              </div>
            </div>
