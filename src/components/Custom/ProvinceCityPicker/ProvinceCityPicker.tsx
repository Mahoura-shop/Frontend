...
export default function ProvinceCityPicker({
	...
	const provinceError =
		touched[provinceFieldName] && errors[provinceFieldName];
	...
	return (
		<div className="grid grid-cols-2 gap-3">
			...
			<div className={styles.container}>
				...
				<label
					className={cn(styles.label, provinceID && styles.floating)}
				>
				...
				<MapPin
					className={cn(
						styles.icon,
						provinceError && "text-destructive",
					)}
				/>
			</div>
			...
			<div className={styles.container}>
				...
				<MapPin
					className={cn(styles.icon, cityError && "text-destructive")}
				/>
			</div>
		</div>
	);
