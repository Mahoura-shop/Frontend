...
export default function AdminLayout({
  ...
  const menuItems = [
    { id: 'dashboard', label: 'داشبورد', icon: Home, href: '/admin/dashboard', count: null },
    { id: 'products', label: 'محصولات', icon: Package, href: '/admin/products', count: 250 },
    { id: 'categories', label: 'دسته‌بندی‌ها', icon: FolderTree, href: '/admin/categories', count: 15 },
    { id: 'brands', label: 'برندها', icon: Tag, href: '/admin/brands', count: 50 },
    { id: 'settings', label: 'تنظیمات', icon: Settings, href: '/admin/settings', count: null },
  ];
        ...
        <header className="sticky top-0 z-40 bg-card border-b border-border shadow-sm">
          <div className="px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold">مدیریت فروشگاه</h1>
            </div>
