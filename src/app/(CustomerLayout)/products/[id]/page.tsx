...
import {
  Heart, ShoppingBag, Star, Minus, Plus, Check, Share2,
  Facebook, Twitter, Instagram, ChevronLeft, Package,
...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-warm dark:bg-gray-950 pt-20">
      {/* Breadcrumb */}
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              ...
              <div className="text-center p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
                ...
                <p className="text-sm font-medium">کیفیت برتر</p>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <Card>
            <CardContent className="p-8">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                {product.ingredients && (
                  <div>
                    <h3 className="text-2xl font-bold mb-4">ترکیبات</h3>
                    <ul className="space-y-3">
              ...
              {product.howToUse && (
                <div className="mt-8 pt-8 border-t">
                  <h3 className="text-2xl font-bold mb-4">نحوه استفاده</h3>
                    ...
                    <Card className="overflow-hidden hover:shadow-xl transition-all cursor-pointer group">
                      ...
                      <CardContent className="p-4">
                        ...
                        <p className="text-lg font-bold gradient-text">
                          {relatedProduct.priceFormatted} تومان
                        </p>
                      </CardContent>
                    </Card>
                  </Link>
