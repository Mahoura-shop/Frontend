	...
	const values = [
		{
			...
			title: "کیفیت برتر",
			description:
				"تمام محصولات ما با بالاترین استانداردهای کیفیتی تولید می‌شوند",
		},
		{
			icon: Award,
			title: "تخصص و تجربه",
					...
					<div className="container mx-auto px-4">
						...
						>
							...
							<p className="text-xl text-muted-foreground leading-relaxed">
								ماهورا با هدف ارائه بهترین محصولات آرایشی و
								بهداشتی لوکس به بازار ایران، فعالیت خود را آغاز
								کرده است.
							</p>
						</motion.div>
					</div>
