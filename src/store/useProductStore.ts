...
const sampleProducts: Product[] = [
  ...
  },
  {
    ...
    category: 'آرایش چشم',
    price: 280000,
    priceFormatted: '۲۸۰,۰۰۰',
    description: 'ماسکارا حجم دهنده برای مژه‌های بلند و پرپشت بدون چسبیدگی.',
    image: 'https://images.unsplash.com/photo-1631214460245-0e9b29740c17?w=800&h=800&fit=crop',
    isNew: true,
    available: true,
    stock: 78,
    rating: 4.7,
